# Написано в соавторстве. Программа выводит изображение люстры и список тэгов для люстры кнопками. Отмечаем нужные тэги,
# кликаем записать.
# на выходе создается файл csv с артикулами люстр в одном столбце и списком тэгов
